...
export doctitle='Pure2D<sup><font size="-2">TM</font></sup> Game Engine'
export header='<img src="pure2d_logo_64.png"><br><b>Pure2D<sup><font size="-2">TM</font></sup> Game Engine </b><br><font size="-1">'$version'</font>'
