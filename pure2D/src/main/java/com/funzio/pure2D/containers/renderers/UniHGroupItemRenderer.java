...
import com.funzio.pure2D.uni.UniHGroup;

/**
 * Created by longngo on 3/25/15.
 */
public class UniHGroupItemRenderer<T> extends UniHGroup implements ItemRenderer<T>, Touchable {
    protected List mList;
    protected int mDataIndex = -1;
    protected T mData;

    public UniHGroupItemRenderer() {
        super();
    }
