 ...
 * @author long
 */
public abstract class CopyOfBaseDisplayObject implements DisplayObject {
    public static final String TAG = CopyOfBaseDisplayObject.class.getSimpleName();
    ...
    final protected GLColor getSumColor() {
        ...
        if (mParent != null && mParent instanceof CopyOfBaseDisplayObject) {
            final CopyOfBaseDisplayObject parent = (CopyOfBaseDisplayObject) mParent;
