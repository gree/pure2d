...
public class WhirlAnimator extends TweenAnimator {
    ...
    protected void onUpdate(final float value) {
        if (mTarget != null) {
            ...
            final float angle = mRadianAngle1 + mRadianLength * (mCircleInterpolator == null ? mCurrentUninterpolatedValue : mCircleInterpolator.getInterpolation(mCurrentUninterpolatedValue));
